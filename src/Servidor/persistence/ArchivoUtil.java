...
public  class ArchivoUtil {
    ...
    private static void cargarFechaSistema() {
        ...
        fecha = diaN + mesN + año + "_" + hora + "_" + minuto + "_" + segundo;
    ...
    public  static void crearCopiaRespaldo(String rutaXML, String nuevaRuta) {
        cargarFechaSistema();
        String nombreArchivo= "model_"+ fecha;
        try {
            File inFile = new File(rutaXML);
            File outFile = new File(nuevaRuta+ nombreArchivo+".xml");
